...
const SAMPLE_LEVEL_ONE_SUBJECTS: SeedSubject[] = [
    {
      ...
      readings: [],
      meaningMnemonic:
        "Imagine the horizon as a flat line across the ground.",
    ...
    },
    {
      ...
      readingMnemonic: "This kanji often uses the onyomi reading いち.",
    },
    {
      id: "l1-vocab-hitotsu",
      type: "VOCABULARY",
      ...
      readings: ["ひとつ"],
      meaningMnemonic:
        "When counting one general thing, 一つ means one thing.",
      readingMnemonic:
        "This vocabulary uses the native Japanese reading ひとつ.",
  },
];
...
export const MOCK_LEVEL_ONE_TO_FIVE_SUBJECTS: SeedSubject[] = [
  ...
  },
  {
    ...
    readingMnemonic: "The onyomi reading is に.",
  },
  {
    id: "l2-radical-mouth",
    type: "RADICAL",
  ...
  },
  {
    ...
    readingMnemonic: "The onyomi reading for this kanji is こう.",
  },
  {
    id: "l3-kanji-tree",
    type: "KANJI",
    ...
    meanings: ["tree"],
    readings: ["き", "もく"],
    meaningMnemonic: "Branches spread from a trunk, giving this kanji a tree shape.",
    readingMnemonic: "Common readings are き and the onyomi もく.",
  },
  {
    id: "l3-vocab-yama",
    type: "VOCABULARY",
    ...
    readingMnemonic: "Use the native reading やま.",
  },
  {
    id: "l4-kanji-fire",
    type: "KANJI",
    ...
    readingMnemonic: "The onyomi reading is か.",
  },
  {
    id: "l4-vocab-water",
    type: "VOCABULARY",
    ...
    readingMnemonic: "Use the reading みず.",
  },
  {
    id: "l5-kanji-gold",
    type: "KANJI",
    ...
    readingMnemonic: "The common onyomi reading is きん.",
  },
  {
    id: "l5-vocab-nihon",
    type: "VOCABULARY",
    ...
    readingMnemonic: "This vocabulary is commonly read にほん.",
  },
];
...
export async function importSubjectsFromJson(
    ...
    await db.withTransactionAsync(async () => {
      await db.runAsync(
        `
          ...
          WHERE user_id = ?
        `,
        [SrsStage.APPRENTICE_1, dueNow, now, userId]
      );
    });
  }
  ...
  export function calculateNextSrsState(
    ...
    const nextReviewAt =
      intervalMs === null ? null : now.getTime() + intervalMs;
  ...
  export async function getDashboardStats(
    ...
    return {
      currentLevel: userRow?.current_level ?? 1,
